...
// fix the page loading problems , it taking too much time to laod the pages like 1 to 2 min 

// after implementing all , use improve codebase architecture but first discuss it also 
